...
## 🎯 Contexte & Objectif (Why?)
*Quel circuit ou fonctionnalité est concerné ? Pourquoi est-ce que on veut créer/modifier cette section? Ça l'apporte quoi au produit ou qu'est-ce que ça change à l'interne? (ex: "Le PLC ne reçoit pas le signal du capteur de fin de course").*

## 🔌 Détails Techniques
*Voltage, Ampérage, Type de signal (Analog/Digital/CAN).*
* Lien vers le schéma (KiCad/Altium/PDF) : [Lien]
...
- [ ] Continuité testée au multimètre.
...
## 🔗 Dépendances
*L'équipe Logiciel a-t-elle besoin de connaître les PINs ?*
