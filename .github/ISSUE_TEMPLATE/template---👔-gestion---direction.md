...
## 🎯 Contexte & Pourquoi ? (Why are we doing this?)
*Explique en quelques phrases pourquoi cette tâche est nécessaire pour le projet (ex: "Obtenir 500$ pour acheter les moteurs", "Réserver le terrain pour le test d'avril").*
...
- [ ] Si partenariat : Le logo du partenaire est ajouté au site web/dossier.

## 💰 Impact Budgétaire
*Est-ce que cette tâche coûte de l'argent ?*
- [ ] Non (0$)
- [ ] Oui (Montant estimé : ____ $)

## 🔗 Dépendances
*Est-ce qu'une autre tâche attend après ça ?*
